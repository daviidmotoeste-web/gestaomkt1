...
export const MyHondaCampaigns: React.FC = () => {
  ...
  const textClass = core === 'MOTOS' ? 'text-red-600' : 'text-red-600';
                            ...
                            <div className="p-4 border-t border-slate-100 dark:border-slate-700 animate-slide-up space-y-6">
                                ...
                                {posVendaItems.length > 0 && (
                                    <div className="space-y-3">
                                        ...
                                        <h3 className="text-xs font-bold text-orange-600 dark:text-orange-400 uppercase tracking-wider flex items-center gap-2 pl-1">
                                            <Wrench size={14} /> 
                                            Pós-Venda & Serviços
                                        </h3>
                                        <div className="grid grid-cols-1 gap-4">
